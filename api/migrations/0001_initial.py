...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name="artists",
            field=models.ManyToManyField(
                related_name="artists", through="api.SongArtist", to="api.artist"
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name="producers",
            field=models.ManyToManyField(
                related_name="producers", through="api.SongProducer", to="api.artist"
            ),
        ),
        migrations.AddConstraint(
            model_name="album",
        ...
        migrations.AddConstraint(
            model_name="songartist",
            constraint=models.UniqueConstraint(
                fields=("song", "artist"), name="unique_vocalist"
            ),
        ),
        migrations.AddConstraint(
            model_name="songproducer",
