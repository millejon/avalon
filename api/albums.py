...
@router.post("", response={201: schema.Album, 400: schema.Error}, tags=["albums"])
...
@router.get(
    "{int:id}", response={200: schema.Album, 404: schema.Error}, tags=["albums"]
)
...
@router.get("", response={200: List[schema.AlbumBasics]}, tags=["albums"])
